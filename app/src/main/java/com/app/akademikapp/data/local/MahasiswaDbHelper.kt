        ...
        if (cursor.moveToFirst()) {
            do {
                val mahasiswa = Mahasiswa(
                    ...
                    nim =
                        cursor.getString(cursor.getColumnIndexOrThrow(COL_NIM)),
                    nama =
                        cursor.getString(cursor.getColumnIndexOrThrow(COL_NAMA)),
                    prodi =
                        cursor.getString(cursor.getColumnIndexOrThrow(COL_PRODI)),
                    semester =
                        cursor.getInt(cursor.getColumnIndexOrThrow(COL_SEMESTER)),
                    email =
